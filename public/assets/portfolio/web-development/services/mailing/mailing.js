jQuery(document).ready(function ($) {
    ...
    // let bodyMail = document.getElementById("bodyMail");
    let firstname = document.getElementById("firstname");
    let surname = document.getElementById("surname");
    let senderEmail = document.getElementById("senderEmail");
    // let baseupload = document.getElementById("baseupload");
    let status = document.getElementById("status");
    // let submit = document.getElementById("sendSubmit");
...
//        $('#sendForm').submit();
//        window.location.href = "sendMailProcess.php";
//        e.preventDefault();
//    });
