...
<div class="container-fluid sending">
    ...
    <div class="alert alert-warning attention" role="alert">
        ...
        <p>В качестве защиты от спам рассылки программа осуществляет реальное отправление писем только в том случае,
            если введен пароль доступа, иначе она лишь симулирует их отправление. Но, чтобы убедить вас в
